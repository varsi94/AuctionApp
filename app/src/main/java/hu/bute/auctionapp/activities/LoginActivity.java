...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View registerButton = findViewById(R.id.registerBtn);
        registerButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult(new Intent(LoginActivity.this, RegisterActivity.class), SIGNUP_REQUEST_CODE);
            }
        });
    ...
    public void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            mEmailView.setError(getString(R.string.error_invalid_accname));
            focusView = mEmailView;
            cancel = true;
        }
